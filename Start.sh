...
tmux new-window -n svrType=1 "./out/build/Debug_linux_llvm/DimensionNightmareServer svrType=1 ip=127.0.0.1 port=1270"
...
tmux new-window -n svrType=3 "./out/build/Debug_linux_llvm/DimensionNightmareServer svrType=3 ip=0.0.0.0 port=1212 byCtl=1 ctlIp=127.0.0.1 ctlPort=1270"
