...
public:
	...
	Task<bool> AddMsg(EMMsgDeal dealType, Message* request, SocketChannel::Ptr channel, Message* response = nullptr,  uint32_t breakTime = 10000)
	{
		int msgId = 0;
		...
		auto send = [&](){
			MessagePackAndSend(msgId, dealType, request, channel, GetWorld());
		};
